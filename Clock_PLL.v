...
/* Fri Apr 04 22:04:24 2025 */


`timescale 1 ns / 1 ps
module Clock_PLL (CLKI, CLKOP, CLKOS, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire LOCK;
    ...
    defparam PLLInst_0.CLKOS_CPHASE = 61 ;
    ...
    defparam PLLInst_0.CLKOS_DIV = 62 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS="8.044355" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 8.044355
